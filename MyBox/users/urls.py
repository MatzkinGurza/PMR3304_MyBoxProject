...
from . import views
from django.urls import path
from .views import UserRegisterView, UserEditView, PasswordsChangeView, ShowProfilePageView, CreateProfileView, CreateStoreView, AddToCartView, CartDetailView, DeleteCartItem, CreateSubscriptionView, DeleteSubscription, CreatePaymentView, SubscriptionListView 
